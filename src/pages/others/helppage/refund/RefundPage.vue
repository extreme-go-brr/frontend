    ...
    <div class="row q-col-gutter-xl">
      ...
      <div :class="['col-12 col-md-3', sidebarBgClass]">
        <div class="row items-center q-mb-md">
          <q-avatar size="40px">
            <img src="/public/helpicon/empty-wallet-change.png" />
          </q-avatar>
          <div class="q-ml-sm">
...
const topics = ref<Topic[]>([
  { tittle: 'Refund Process', questions: ['How do I request a refund?'] },
  { tittle: 'Refund Eligibility', questions: ['Can I get a refund for a used item?'] },
  { tittle: 'Refund Issuance', questions: ['How will my refund be issued?'] },
  { tittle: 'Refund Denial', questions: ['Why was my refund request rejected?'] },
  { tittle: 'Receiving Refunds Using Different Payment Methods', questions: ['Can I receive my refund through a different payment method?'] },
  { tittle: 'Appeal Against Refund Rejection', questions: ['Can I appeal a denied refund?'] }
])
