    ...
    <div class="row q-col-gutter-xl">
      ...
      <div :class="['col-12 col-md-3', sidebarBgClass]">
        <div class="row items-center q-mb-md">
          <q-avatar size="40px">
            <img src="/public/helpicon/box.png" />
          </q-avatar>
          <div class="q-ml-sm">
            <div class="text-subtitle1 text-weight-bold">Ordered Item</div>
            <q-btn
              flat
              dense
              no-caps
...
const topics = ref<Topic[]>([
  { tittle: 'Check Item Availability', questions: ['How do I know if an item is in stock?'] },
  { tittle: 'Product Not Available', questions: ['Why was my ordered item suddenly marked as unavailable?'] },
  { tittle: 'Change or Cancel My Order', questions: ['Can I cancel or modify my order after placing it?'] },
  { tittle: 'Reorder The Same Item', questions: ['How can I reorder the same item?'] },
  { tittle: 'Product Specifications', questions: ['Where can I find the product technical specifications?'] }
])
