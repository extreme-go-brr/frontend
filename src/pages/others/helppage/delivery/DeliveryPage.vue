    ...
    <div class="row q-col-gutter-xl">
      ...
      <div :class="['col-12 col-md-3', sidebarBgClass]">
        <div class="row items-center q-mb-md">
          <q-avatar size="40px">
            <img src="/public/helpicon/truck-fast.png" />
          </q-avatar>
          <div class="q-ml-sm">
...
const topics = ref<Topic[]>([
  { tittle: 'Long of Delivery Take', questions: ['How long does delivery usually take?'] },
  { tittle: 'Tracking Delivery Status', questions: ['How can I track the status of my shipment?'] },
  { tittle: 'Shipping Fees & Courier Options', questions: ['What shipping methods are available?'] },
  { tittle: 'Your Package Delayed', questions: ['What should I do if my package is delayed?'] },
  { tittle: 'Change Adress After Ordering', questions: ['Can I change my shipping address after ordering?'] },
  { tittle: 'Your Package Is Lost', questions: ['What happens if my package is lost or not delivered?'] }
])
