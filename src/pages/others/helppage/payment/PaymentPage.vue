    ...
    <div class="row q-col-gutter-xl">
      ...
      <div :class="['col-12 col-md-3', sidebarBgClass]">
        <div class="row items-center q-mb-md">
          <q-avatar size="40px">
            <img src="/public/helpicon/dollar-circle.png" />
          </q-avatar>
          <div class="q-ml-sm">
            <div class="text-subtitle1 text-weight-bold">Payment</div>
            <q-btn
              flat
              dense
              no-caps
...
const topics = ref<Topic[]>([
  { tittle: 'Supported Payment Methods', questions: ['What payment methods are accepted on Maker.id?'] },
  { tittle: 'Failed Payment', questions: ['My payment failed, but I was charged — what should I do?'] },
  { tittle: 'Pay Via Bank Transfer', questions: ['Can I pay via manual bank transfer?'] },
  { tittle: 'Getting Invoice After Ordering', questions: ['Can I get a receipt or invoice for my order?'] },
  { tittle: 'Using E-Wallet For Paying', questions: ['Can I pay using e-wallets like OVO, GoPay, or DANA?'] },
  { tittle: 'Payment Security & Encryption', questions: ['Is my payment information safe on Maker.id?'] },
  { tittle: 'Using Voucher Codes', questions: ['How do I use a promo or discount code?'] }
])
